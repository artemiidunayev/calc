...
public class Main {
    ...
    public static String calc(String input) throws Exception {
        String[] splittingString = input.split(" ");
        ...
        if (number1 == -1) {
            romanOrArab = false || arabOrRoman == false;
        ...
        if (number1 > 10 || number2 > 10) {
            throw new Exception("Ââåäåíûå ÷èñëà áîëüøå 10");
        }
        ...
        if (arabOrRoman == true && romanOrArab == true) {
            return getRomeNumber(answer);
        } else {
